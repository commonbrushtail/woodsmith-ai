...
Test-first approach for all infrastructure and polish phases. Every feature follows the
...
- [Phase 1: Infrastructure (Steps 0–10)](#phase-1-infrastructure-steps-010)
- [Phase 4–5: Polish & Enhancements (Sessions 1–7)](#phase-45-polish--enhancements-sessions-17)
- [Dependency Summary](#dependency-summary)
- [Environment Variables](#environment-variables)

---

# Phase 1: Infrastructure (Steps 0–10)
...
# Phase 4–5: Polish & Enhancements (Sessions 1–7)
...
| S5 | Auth Gaps (LINE, forgot-password) | ~6 | 8 | Done |
| S6 | Security Hardening | ~15 | 10 | Done |
| S7 | Test Coverage Expansion | ~30 | 20 | Done |
...
| 1 | `@testing-library/react` | Component rendering + interaction |
| 1 | `@testing-library/jest-dom` | DOM assertion matchers |
| 1 | `jsdom` | Browser environment simulation |
| 1 | `playwright` | End-to-end browser testing |
| 4-5 S3 | `@tiptap/react` | Rich text editor React binding |
| 4-5 S3 | `@tiptap/starter-kit` | Essential extensions bundle |
| 4-5 S3 | `@tiptap/extension-image` | Image embedding |
| 4-5 S3 | `@tiptap/extension-link` | Link insertion |
| 4-5 S4 | `@dnd-kit/core` | Drag-and-drop primitives |
| 4-5 S4 | `@dnd-kit/sortable` | Sortable list preset |
| 4-5 S4 | `@dnd-kit/utilities` | CSS transform utilities |

## Database Migrations

| Phase | Migration | Purpose |
|-------|-----------|---------|
| 1 | `001_initial_schema.sql` | All 14 tables, enums, indexes, triggers |
| 1 | `002_rls_policies.sql` | Row-level security policies |
| 4-5 S6 | `004_audit_logs.sql` | Audit logging table |
