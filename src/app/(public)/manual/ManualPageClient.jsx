...
const fallbackManuals = [
  { id: 1, image: imgCard1, title: 'คู่มือแนะนำการติดตั้งวงกบห่อ PVC', date: '25 ตุลาคม 2568', pdfUrl: '#', youtubeUrl: 'https://youtube.com' },
  { id: 2, image: imgCard2, title: 'คู่มือแนะนำการติดตั้งไม้ฝากแนวต่อ HMR', date: '25 ตุลาคม 2568', pdfUrl: '#', youtubeUrl: 'https://youtube.com' },
  { id: 3, image: imgCard1, title: 'คู่มือแนะนำการติดตั้งไม้ปิ่นโต', date: '25 ตุลาคม 2568', pdfUrl: '#', youtubeUrl: null },
  { id: 4, image: imgCard2, title: 'คู่มือแนะนำการติดตั้งไม้ผ้า ใช้กาวเบอร์', date: '25 ตุลาคม 2568', pdfUrl: '#', youtubeUrl: null },
  { id: 5, image: imgCard1, title: 'คู่มือแนะนำการติดตั้งไม้ผ้าหนังผิน', date: '25 ตุลาคม 2568', pdfUrl: '#', youtubeUrl: 'https://youtube.com' },
  { id: 6, image: imgCard2, title: 'คู่มือแนะนำการติดตั้งประตูพร้อมวงกบ', date: '20 ตุลาคม 2568', pdfUrl: '#', youtubeUrl: 'https://youtube.com' },
]
...
export default function ManualPageClient({ manuals: dbManuals = [] }) {
  ...
  const allManuals = dbManuals.length > 0
    ? dbManuals.map(m => ({
        id: m.id,
        image: m.cover_image_url || imgCard1,
        title: m.title,
        date: m.created_at ? new Date(m.created_at).toLocaleDateString('th-TH', { year: 'numeric', month: 'long', day: 'numeric' }) : '',
        pdfUrl: m.file_url,
