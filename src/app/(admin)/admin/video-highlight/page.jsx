...
const MOCK_HIGHLIGHTS = [
  {
    id: 1,
    order: 1,
    title: 'WoodSmith Art Collaboration Interview Artist \u0e04\u0e38\u0e13\u0e19\u0e34\u0e21\u0e34\u0e15 \u0e17\u0e34\u0e1e\u0e23...',
    category: '\u0e0a\u0e37\u0e48\u0e2d\u0e2b\u0e21\u0e27\u0e14\u0e2b\u0e21\u0e39\u0e48',
    author: 'WoodSmith A',
    publishDate: '\u0e27\u0e31\u0e19\u0e2d\u0e31\u0e07\u0e04\u0e32\u0e23 \u0e17\u0e35\u0e48 28 \u0e15\u0e38\u0e25\u0e32\u0e04\u0e21 \u0e1e.\u0e28. 2568 \u0e40\u0e27\u0e25\u0e32 11:54',
    recommended: true,
    published: true,
  },
  {
...
/* ------------------------------------------------------------------ */
function ActionMenu({ highlightId, onClose }) {
  ...
  return (
    ...
    >
      <Link
        href={`/admin/video-highlight/edit/${highlightId}`}
...
/*  Page component                                                     */
/* ------------------------------------------------------------------ */
export default function VideoHighlightPage() {
  ...
  const allSelected = selectedRows.length === MOCK_HIGHLIGHTS.length && MOCK_HIGHLIGHTS.length > 0
  ...
  function toggleSelectAll() {
    if (allSelected) {
      ...
      setSelectedRows(MOCK_HIGHLIGHTS.map((h) => h.id))
    }
  }
  ...
  const sortedHighlights = [...MOCK_HIGHLIGHTS].sort((a, b) =>
  ...
  function renderPageNumbers() {
    ...
    pages.push(
      <button
        ...
        className="size-[32px] flex items-center justify-center rounded-[6px] border border-[#e5e7eb] bg-white text-[#6b7280] hover:bg-[#f9fafb] disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
    ...
    for (let i = 1; i <= 3; i++) {
      pages.push(
        <button
          ...
          className={`size-[32px] flex items-center justify-center rounded-[6px] text-[13px] font-medium cursor-pointer ${
            currentPage === i
                ...
                >
                  ...
                  <td className="px-[12px] py-[10px]">
                    <input
                      ...
                      className="size-[16px] accent-[#ff7e1b] cursor-pointer rounded"
                      aria-label={`Select highlight ${highlight.order}`}
                    />
                  </td>
                  {/* Order */}
                  ...
                  <td className="px-[10px] py-[10px] text-[12px] text-[#6b7280] min-w-[200px]">
                    <div className="leading-[1.5]">{highlight.publishDate}</div>
                  </td>
                  {/* Recommended status */}
                  <td className="px-[10px] py-[10px]">
                    {renderRecommendedBadge(highlight.recommended)}
                  </td>
                  {/* Publish status */}
                  <td className="px-[10px] py-[10px]">
                    {renderPublishBadge(highlight.published)}
                  </td>
                  {/* Action dots */}
                  <td className="px-[10px] py-[10px] text-center">
                    <div className="relative inline-block">
                      <button
                        onClick={() =>
                          setOpenMenuId(openMenuId === highlight.id ? null : highlight.id)
                        }
                        ...
                        aria-label={`Actions for highlight ${highlight.order}`}
                        aria-haspopup="true"
