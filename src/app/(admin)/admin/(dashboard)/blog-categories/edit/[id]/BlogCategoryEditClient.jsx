...
export default function BlogCategoryEditClient({ category }) {
  ...
  const handleSave = async () => {
    ...
    startTransition(async () => {
      ...
      const result = await updateBlogCategory(category.id, formData)
  ...
  const handleDelete = async () => {
    startTransition(async () => {
      ...
      if (result.warning) {
        ...
        if (confirmDelete) {
          const forceResult = await deleteBlogCategory(category.id, { force: true })
