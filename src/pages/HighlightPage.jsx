...
const baseHighlights = [
  ...
  },
  {
    ...
    title: 'WoodSmith Art Collaboration Interview Artist คุณบิ๊ก ศิริวัฒ ประสานทอง',
  },
  {
    image: imgImage2,
    duration: '1:29',
  ...
  },
  {
    image: imgImage3,
    duration: '6:51',
    channelName: 'WoodSmith Guest Interview คุณหนุ่ย สุวรรณ...',
    title: 'WoodSmith Guest Interview คุณหนุ่ย สุวรรณนี สุวรรณมณีรัตน์',
  },
]

const allHighlights = Array.from({ length: 30 }, (_, i) => ({
  id: i + 1,
  ...baseHighlights[i % baseHighlights.length],
}))
...
export default function HighlightPage() {
  ...
  return (
    <div className="flex flex-col items-center w-full pb-[36px] lg:pb-[60px]">
      ...
      {/* Mobile: single column with load more */}
