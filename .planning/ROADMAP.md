...
Plans:
- [x] 04-01-PLAN.md — Variation tables schema (013) and RLS policies (014) ✓
...
Plans:
- [x] 05-01-PLAN.md — Zod validation schemas + 10 server actions for variation group/entry CRUD ✓
...
Plans:
- [x] 06-01-PLAN.md — Sidebar nav + variation list page with group table ✓
- [x] 06-02-PLAN.md — Create and edit pages with entry management, swatch upload, and drag-drop reorder ✓
